...
#### Fully-configured SSH Config Example
...
![](CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_ssh_2.png)
...
![](CIDA_BIOS_Cluster_Interactive_IDEs_figures/localhost_test.png)

Moving back to your SSH window, you should see some error messages populate the screen:

![](CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_ssh_local_forward_test.png)
...
![](CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_rstudio_launch.png)
...
![](CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_rstudio_interface.png)
...
![](CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_jupyter_launch.png)
...
![](CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_jupyter_interface.png)
...
### Customizing the JupyterLab Job
...
## Quickstart (for returning users)
...
## (Optional) Additional Options and Job Customization
...
![](CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_rstudio_diagram.png)
